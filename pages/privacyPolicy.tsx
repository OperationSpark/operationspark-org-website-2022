              ...
              <li>
                <p>
                  ...
                  {` (referred to as either "the
                    ...
                    Operation Spark is a 501(c)(3) not-for-profit, 514 Franklin
            ...
            <ul>
              <li>
                <p>
                  By email:{' '}
                  <a
                    href='mailto:support@operationspark.org'
                    rel='external nofollow noopener noreferrer'
                    target='_blank'
                  >
                    support@operationspark.org
                  </a>
                </p>
              </li>
              <li>
              ...
              <li>
                By mail:{' '}
                <a
                  href='https://www.google.com/maps/place/514+Franklin+Ave,+New+Orleans,+LA+70117'
                  rel='external nofollow noopener noreferrer'
                  target='_blank'
                >
