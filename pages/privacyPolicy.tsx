        ...
        <PrivacyPolicyStyles>
          <div className='header'>
            <div className='container'>
              <p className='title'>Privacy Policy for Operation Spark</p>
            </div>
          </div>
            ...
            <div className='container'>
              <div className='tab-content translations-content-item en visible' id='en'>
                <PlainCard>
                  ...
                  <p>
                    <b className='primary-secondary'>Last updated: December 24, 2022</b>
                  </p>
                  <p>
                ...
                <ul>
                  ...
                  <li>
                    <p>
                      ...
                      "Our" in this Agreement) refers to Operation Spark, 514 Franklin Avenue New
                      Orleans, LA 70117.`}
                    </p>
                  </li>
                  <li>
                  ...
                  <li>
                    <p>
                      <strong>Country</strong> refers to: Louisiana, United States
                    </p>
                  </li>
                  <li>
                    <p>
                  ...
                  <li>
                    <p>
                      <strong>Website</strong> refers to Operation Spark, accessible from{' '}
                      <a
                ...
                <ul>
                  <li>
                    <p>
                      <b>By email: </b>
                      <a href='mailto:support@operationspark.org'>support@operationspark.org</a>
                    </p>
                  </li>
                  <li>
                    <p>
                      ...
                      <a
                        href='https://operationspark.org/contact'
                        rel='external nofollow noopener noreferrer'
                        target='_blank'
                      >
                        https://operationspark.org/contact
                      </a>
                    </p>
                  </li>
                  <li>
                  ...
                  <li>
                    <p>
                      <b>By mail: </b>
                      <a href='https://goo.gl/maps/X6eQ54sWbbH2RbVd8'>
